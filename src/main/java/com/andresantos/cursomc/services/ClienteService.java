...
public class ClienteService {
	...
	public Cliente insert(Cliente obj) {
		obj.setId(null); // para garantir que estou inserindo sempre um cliente novo
		obj = repo.save(obj);
		enderecoRepository.saveAll(obj.getEnderecos());// salvar a lista de endereços do Cliente
		return obj;
	}
